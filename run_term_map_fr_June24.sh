...
python3 "$5/make_io_file.py" "$1" "$3.internal_terms_list" .terms

if [ "$6" = "zh" ]; then
   python3 "$5/summary/term_generator.py" "$3"
fi
...
python3 "$5/run_term_map.py" "$2" "$3.internal_terms_list" "$3.term_instance_map" "$4"
